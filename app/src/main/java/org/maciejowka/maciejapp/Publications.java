...
public class Publications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new OnMaciejPublicationsClickListener());
        PublicationsLoader.publicationsActivityContext = this;
        new PublicationsLoader().execute();
        Log.d("MyLog","onCreate()");
    }

    private class OnMaciejPublicationsClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            switch (position) {
                ...
                case 1:{
                    Intent intent = new Intent(Publications.this, ArchivalPublicationsList.class);
                    startActivity(intent);
                    break;
                }
